...
function QuickAccess({ title, number }) {
  return (
    number <= 0 ? (
    <MDBCard shadow='0' border='success' background='white' className='mb-3 ms-3' style={{ maxWidth: '18rem' }}>
      ...
      <MDBCard shadow='0' border='warning' background='white' className='mb-3  ms-3' style={{ maxWidth: '18rem' }}>
